...
const Trending = () => {
    ...
    useEffect(() => {
        fetch(`https://api.themoviedb.org/3/trending/movie/day?api_key=22abeadcfc022241b78e1520137e687e`)
            .then(res => res.json())
    ...
    return (
        <>
            <div className='bg-black w-full rounded-lg h-full p-15 text-white'>
